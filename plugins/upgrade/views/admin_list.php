...
<tbody>
    <tr>
		...
		<td align="left"><a href="http://www.finecms.net/update/" target="_blank">程序更新记录</a></td>
    </tr>
...
<thead>
	<tr>
		...
		<th align="left">更新包下载</th>
	</tr>
</thead>
<tbody>
	<?php foreach($data as $version=>$update) { ?>
	<tr>
		<td>v<?php echo $version;?></td>
		<td><?php echo $update;?></td>
		<td><a href="http://down.finecms.net/<?php echo $version;?>.zip" target="_blank">http://down.finecms.net/<?php echo $version;?>.zip</a></td>
	</tr>
	<?php }?>
</tbody>
</table>
