...
return array (
    ...
    'top' => array (
				...
				1 => array('name' => 'a-men-1', 'url' => url('admin/index/config'),   'select' => '101', 'option' => array('index-config', 'user-index','auth-index','index-log','index-attack', 'ip-index')),
				2 => array('name' => 'a-men-2', 'url' => url('admin/category/index'), 'select' => '201', 'option' => array('category-index', 'model-index', 'attachment-index', 'position-index', 'content-index', 'relatedlink-index', 'block-index', 'linkage-index')),
				7 => array('name' => 'a-men-3', 'url' => url('admin/form/index'),     'select' => '701', 'option' => array('form-index')),
				6 => array('name' => 'a-men-4', 'url' => url('admin/html/index'),     'select' => '601', 'option' => array('html-index', 'html-cache')),
				3 => array('name' => 'a-men-5', 'url' => url('admin/member/index'),   'select' => '301', 'option' => array('member-index', 'member-config', 'member-group', 'member-pms')),
	...
	'list' => array(
	            0 => array(
					...
					'a-men-10' => array(
						4 => array('name' => CMS_NAME . ' ' . CMS_VERSION, 'sys'=>1)
					),
				),
			    1 => array(
					'a-men-11' => array(
						101 => array('name' => 'a-men-12', 'url' => url('admin/index/config', array('type'=>1)),  'option'=>'index-config'),
						116 => array('name' => 'a-men-65', 'url' => url('admin/index/config', array('type'=>7)),  'option'=>'index-config'),
						102 => array('name' => 'a-men-13', 'url' => url('admin/index/config', array('type'=>2)),  'option'=>'index-config'),
						103 => array('name' => 'a-men-14', 'url' => url('admin/index/config', array('type'=>3)),  'option'=>'index-config'),
						104 => array('name' => 'a-men-15', 'url' => url('admin/index/config', array('type'=>4)),  'option'=>'index-config'),
						105 => array('name' => 'a-men-16', 'url' => url('admin/index/config', array('type'=>5)),  'option'=>'index-config'),
						115 => array('name' => 'a-men-17', 'url' => url('admin/index/config', array('type'=>6)),  'option'=>'index-config'),
						...
						107 => array('name' => 'a-men-19', 'url' => url('admin/index/cache'),  'option' => 'index-cache'),
					),
					'a-men-20' => array(
				...
				2 => array(
					...
					'a-men-29' => array(
						209 => array('name' => 'a-men-30', 'url' => url('admin/block/index'),        'option' => 'block-index'),
						208 => array('name' => 'a-men-31', 'url' => url('admin/position/index'),     'option' => 'position-index'),
						207 => array('name' => 'a-men-32', 'url' => url('admin/tag/index'),          'option' => 'tag-index'),
						206 => array('name' => 'a-men-33', 'url' => url('admin/relatedlink/index'),  'option' => 'relatedlink-index'),
						205 => array('name' => 'a-men-34', 'url' => url('admin/linkage/index'),      'option' => 'linkage-index'),
				...
				4 => array(
					'a-men-47' => array(
						...
						402 => array('name' => 'a-men-19', 'url' => url('admin/theme/cache'), 'option' => 'theme-cache'),
					)
		        ),
				6 => array(
					'a-men-49' => array(
